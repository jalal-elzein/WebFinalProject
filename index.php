    ...
    <body>
        ...
        <div class="paragraph" style="border:0;">
            <form class="form" action="./backend/login.php" method="POST" name="login-form">
                ...
                <br><br>
                <button onclick="window.location.href='..';" class="btn btn-outline-danger" type="button">
        ...
        <br>
        <button onclick="window.location.href='..';" class="btn btn-outline-danger" type="button" style="top: 200;left: 46.5%;position: relative;">
                <i class="fas fa-user"></i>
                Sign Up
        </button>
